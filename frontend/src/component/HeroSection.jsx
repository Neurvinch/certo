        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#" className="inline-flex items-center justify-center rounded-full bg-amber-400 px-5 py-3 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-amber-300 transition hover:bg-amber-300">
              ...
              <a href="#" className="inline-flex items-center justify-center rounded-full border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50">
